...
然后打开blog\source\talk\[index.md](http://index.md)
...
代码中有一处要修改成你自己的ID，我按照Leonus的教程中关于用户ID获取的方法操作之后，发现本该显示ID的地方显示成了我的用户名

![](https://blog-images.luckyabner.top/20251029-202308201604729.png)

我原本以为这里的用户名就是我的id，但放到代码中提示是错误的，我在这里卡了好久，在我的一番摸索之下，我发现了一个新的获取id的方法：

点击memos的RSS

![](https://blog-images.luckyabner.top/20251029-202308201610379.png)

这里这url中u/后面的数字就是我们的ID

![](https://blog-images.luckyabner.top/20251029-202308201612824.png)
...
![](https://blog-images.luckyabner.top/20251029-202308201616189.jpg)
